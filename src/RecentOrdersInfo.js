...
export default function RecentOrdersInfo() {
  ...
  useEffect(() => { const ordersInfo =  async () => {
    ...
    <div className="all-containers">
      <div className="all-info-container large-devices-container md-devices-container small-devices-container">
        <div className="info-container">
          ...
          <img src="https://res.cloudinary.com/dbatijrbu/image/upload/v1701689454/service_9119160_luxciw.png" alt="Total Orders" className="info-icons"/>
        </div>
      ...
      <div className="all-info-container large-devices-container md-devices-container small-devices-container">
        <div className="info-container">
          ...
          <img src="https://res.cloudinary.com/dbatijrbu/image/upload/v1701504385/box_1524935_f2ofhx.png" alt="Total Customers" className="info-icons"/>
        </div>
      ...
      <div className="all-info-container large-devices-container md-devices-container small-devices-container">
        <div className="info-container">
          ...
          <img src="https://res.cloudinary.com/dbatijrbu/image/upload/v1701689454/sale_5661388_zjowna.png" alt="Total Sales" className="info-icons"/>
        </div>
      ...
      <div className="all-info-container large-devices-container md-devices-container small-devices-container">
        <div className="info-container">
          ...
          <img src="https://res.cloudinary.com/dbatijrbu/image/upload/v1701689454/revenue_9926769_bcxvs8.png" alt="Total Revenue" className="info-icons"/>
        </div>
